...
<div class="container-fluid">
  <div class="container">
    <nav class="breadcrumb bg-transparent m-0 p-0">
      ...
      <!-- <a class="breadcrumb-item" href="#">Kategori</a> -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="position-relative mb-3">
              <img class="img-fluid w-100" src="{{asset("image/kp-karet-512.png")}}" style="object-fit: cover;">
              <div class="overlay position-relative bg-light">
                <a class="h4" href="{{route('category.single', [$category['slug']])}}">{{ ucwords($category['name']) }}</a>
                <p class="m-0">{{ucfirst($category['description'])}}</p>
              </div>
            </div>
          </div>
          @endforeach
      ...
      <div class="col-lg-4 pt-3 pt-lg-0">
        ...
        <div class="pb-3">
          ...
          <div class="d-flex mb-3">
            ...
            <img class="img-fluid w-100" src="{{ $trend['image'] }}" style="width: 100px; height: 100px; object-fit: cover;">
            @else
            <img class="img-fluid w-100" src="{{asset('post-image/' . $trend['image'])}}" style="width: 100px; height: 100px; object-fit: cover;">
            @endif
